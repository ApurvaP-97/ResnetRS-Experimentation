...
"""Block implementation referenced from HW2 structure and https://github.com/rwightman/pytorch-image-models/blob/master/timm/models/resnet.py"""
...
class StemBlock(nn.Module):
    def __init__(self, in_ch=3, stem_width=128, norm_layer=nn.BatchNorm2d,
        ...
        self.conv1 = nn.Sequential(*[
            nn.Conv2d(in_ch, stem_width, kernel_size=3, stride=2, padding=1,bias=False),
